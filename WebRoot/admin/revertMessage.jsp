		...
		<table border="2">
			...
			<c:forEach items="${listRev }" var="rev">
				<tr>
					...
					<td>${rev.writeDate }</td>
					<td><a
						href="${pageContext.request.contextPath }/admin/deleteRev.do?revertID=${rev.revertID }&messageID=${message.messageID}">删除</a></td>
				</tr>
			</c:forEach>
		</table>
		<hr>
		<form action="${pageContext.request.contextPath }/admin/insertRev.do"
			method="post">
			<h4>添加留言回复</h4>
